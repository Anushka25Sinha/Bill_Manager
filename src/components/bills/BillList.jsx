...
import { selectFilteredBills, selectOptimalBills } from '../../features/bills/selectors';
...
const BillList = () => {
    ...
    const { optimalBillIds, count, totalAmount } = useSelector(selectOptimalBills);
            ...
            {optimalBillIds.size > 0 && (
                <div className="glass-effect rounded-xl p-4 flex items-center gap-3">
                    ...
                    <div className="text-slate-200 text-sm md:text-base">
                        <span className="font-semibold">{count} bills</span> can be paid within budget
                ...
                ${optimalBillIds.has(bill.id) ? 'bg-green-900/20' : ''}`}
                        >
                            <div className="flex items-start justify-between">
                                <div className="space-y-1">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <p className="font-medium text-slate-200">{bill.description}</p>
                                    </div>
                            ...
                            <div className="flex justify-between text-sm">
                                ...
                                <span className="font-medium text-slate-200">{formatCurrency(bill.amount)}</span>
                            </div>
                        </div>
                    ))}
                </div>
