...
const BillChart = () => {
    ...
    const chartData = useMemo(() => {
        return bills
            .map(bill => ({
                date: new Date(bill.date).toLocaleDateString('en-US', { month: 'short', day: 'numeric' }),
            ...
            <div className="p-4 md:p-6 space-y-6">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                    <div>
                        ...
                        <p className="text-sm text-slate-400 mt-1">Monthly spending analysis</p>
                    </div>
    ...
    //     <div className="rounded-2xl bg-gray-800/50 backdrop-blur-lg border border-gray-700/50">
    // <div className="p-4 md:p-6 space-y-6">
    //     {/* Header Section */}
    //     <div className="flex flex-col md:flex-row justify-between items-start gap-4">
    //         <div>
    ...
    //                 Expense Trends
    //             </h2>
    //             <p className="text-sm text-gray-400 mt-1">Monthly spending analysis</p>
    //         </div>

    //         {/* Stats Section */}
    //         <div className="grid grid-cols-2 md:grid-cols-3 gap-4 w-full md:w-auto">
    //             <div className="bg-gray-700/20 rounded-lg p-3">
    //                 <p className="text-xs text-gray-400">Highest Spend</p>
    //                 <p className="text-base md:text-lg font-semibold text-gray-200">
    //                     {formatCurrency(maxAmount)}
    //                 </p>
    //             </div>
    //             <div className="bg-gray-700/20 rounded-lg p-3">
    //                 <p className="text-xs text-gray-400">Lowest Spend</p>
    //                 <p className="text-base md:text-lg font-semibold text-gray-200">
    //                     {formatCurrency(minAmount)}
    //                 </p>
    //             </div>
    //             <div className="bg-gray-700/20 rounded-lg p-3 col-span-2 md:col-span-1">
    ...
    //                     tickLine={{ className: 'stroke-gray-700' }}
    //                     axisLine={{ className: 'stroke-gray-700' }}
    //                     tickMargin={10}
    //                 />
    //                 <YAxis
    //                     className="text-gray-400 text-xs"
    ...
    //                 />
    //                 <Tooltip
    //                     contentStyle="bg-gray-800 border border-gray-700 rounded-lg p-3 shadow-lg"
    //                     itemStyle="text-gray-300 text-sm"
    //                     labelStyle="text-gray-400 text-xs mb-2"
    //                     formatter={(value) => [`${formatCurrency(value)}`, 'Amount']}
    //                     labelFormatter={(label) => `Date: ${label}`}
    //                 />
    //                 <Line
    ...
    //                     strokeWidth={2}
    //                     dot={{ className: 'fill-orange-500 stroke-gray-800 stroke-2', r: 4 }}
    //                     activeDot={{
    //                         r: 6,
    //                         className: 'fill-orange-500 stroke-gray-800 stroke-2'
    //                     }}
    //                 />
    //             </LineChart>
    //         </ResponsiveContainer>
    ...
    //     {/* Empty State */}
    //     {chartData.length === 0 && (
    //         <div className="absolute inset-0 flex items-center justify-center bg-gray-800/50 backdrop-blur-sm rounded-2xl">
